...
pub trait PointerMotionAbsoluteEvent<B: InputBackend>: PositionEvent<B> {}
impl<B: InputBackend> PointerMotionAbsoluteEvent<B> for UnusedEvent { }

/// Input event with location data.
pub trait PositionEvent<B: InputBackend>: Event<B> {
...
impl<B: InputBackend> PositionEvent<B> for UnusedEvent {
    fn x(&self) -> f64 {
        match *self {}
    }
...
pub trait TouchDownEvent<B: InputBackend>: TouchEvent<B> + PositionEvent<B> {}
impl<B: InputBackend> TouchDownEvent<B> for UnusedEvent {}

/// Trait for touch events regarding movement on the screen
pub trait TouchMotionEvent<B: InputBackend>: TouchEvent<B> + PositionEvent<B> {}
